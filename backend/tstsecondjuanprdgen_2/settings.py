"""
Django settings for tstsecondjuanprdgen_2 project.
...
ROOT_URLCONF = 'tstsecondjuanprdgen_2.urls'
...
WSGI_APPLICATION = 'tstsecondjuanprdgen_2.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tstsecondjuanprdgen_2 API",
    "DESCRIPTION": "API documentation for tstsecondjuanprdgen_2 App",
    "VERSION": "v1",
}
